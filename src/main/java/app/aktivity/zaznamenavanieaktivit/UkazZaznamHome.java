...
public class UkazZaznamHome extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ukaz_zaznam_home);

        //zmazanie názvu v ActionBar
        ActionBar actionBar = getSupportActionBar();
        actionBar.setDisplayShowTitleEnabled(false);

        nazov = (TextView)findViewById(R.id.tvUkazHomeNazov);
        datum = (TextView)findViewById(R.id.tvUkazHomeDatum);
        cas = (TextView)findViewById(R.id.tvUkazHomeCas);
        poznamka = (TextView)findViewById(R.id.tvUkazHomePoznamka);
        zmazat = (Button)findViewById(R.id.btnHomeZmazat);
        upravit = (Button)findViewById(R.id.btnHomeUpravit);
                ...
                new AlertDialog.Builder(UkazZaznamHome.this)
                        ...
                        .setPositiveButton("Áno", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Toast.makeText(UkazZaznamHome.this, "Záznam bol zmazaný.", Toast.LENGTH_SHORT).show();
                                finish();
                                if(newPocet > 0){
                                    Intent intent = new Intent(UkazZaznamHome.this, ZaznamyList.class);
                                    intent.putExtra("nazov", zaznam.get("nazov"));
                                    startActivity(intent);
                                }else{
                                    Intent intent = new Intent(UkazZaznamHome.this, MainActivity.class);
                                    startActivity(intent);
                                }
                            }
                        })
        ...
        upravit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent theIntent = new Intent(UkazZaznamHome.this, UpravitZaznam.class);
                theIntent.putExtra("zaznamId", sZaznamId);
                theIntent.putExtra("path", "ukazZaznamHome");
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(this, ZaznamyList.class);
        intent.putExtra("nazov", zaznam.get("nazov"));
        startActivity(intent);
    }
