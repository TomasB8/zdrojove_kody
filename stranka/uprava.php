...
<?php $actual_page = "tabulka"; ?>
    <div id="main">
        ...
        <form class="formular zadavanie" action="" method="post">
                ...
                <input type="number" name="voda" id="voda" step="any">°C<br>
                ...
                <input id="btnUlozitZaznam" type="button" name="pridat" value="Uložiť zmeny">
            </form>
        </div>
    </div>
</div>
    <?php include "ine/footer.php" ?>
    <script src="javascript/uprava.js"></script>
