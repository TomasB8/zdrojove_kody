...
<?php $actual_page = "prihlasenie"; ?>
    <div id="main">
        ...
        <input id="btnPassReset" type="button" value="Odoslať email" name="submit"/>
  <p class="link"> Chcete sa prihlásiť? <a href="login.php">Prihlásenie</a></p>
  </form>
        </div>
</div>
    </div>
    <?php include "ine/footer.php" ?>
    <script src="javascript/zabudnute_heslo.js"></script>
